...
<body class="antialiased">
        ...
        <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
            <a href="/" class="flex items-center gap-2" aria-label="Tikona home">
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    <path d="M5 10.5H19.5V16C19.5 19.5898 16.5898 22.5 13 22.5H11.5C7.91015 22.5 5 19.5898 5 16V10.5Z" stroke="#2B2420" stroke-width="1.6"/>
                    <path d="M19.5 12H21.5C22.8807 12 24 13.1193 24 14.5C24 15.8807 22.8807 17 21.5 17H19.3" stroke="#2B2420" stroke-width="1.6" stroke-linecap="round"/>
                    <path d="M9 6C9 6 8 7.2 9 8.4C10 9.6 10 10.5 10 10.5" stroke="#E29C23" stroke-width="1.6" stroke-linecap="round"/>
                    <path d="M13.5 6C13.5 6 12.5 7.2 13.5 8.4C14.5 9.6 14.5 10.5 14.5 10.5" stroke="#E29C23" stroke-width="1.6" stroke-linecap="round"/>
            ...
            <nav class="hidden items-center gap-8 text-[15px] md:flex" aria-label="Primary">
                <a href="/" class="{{ $navLink('/', 'Home')['classes'] }}">Home</a>
                <a href="/about" class="{{ $navLink('/about', 'About')['classes'] }}">About</a>
                <a href="/product" class="{{ $navLink('/product', 'Product')['classes'] }}">Product</a>
                <a href="/order" class="{{ $navLink('/order', 'Order')['classes'] }}">Order</a>
            </nav>

            <div class="flex items-center gap-3">
                <a href="/login" class="rounded-full border border-[var(--line)] px-4 py-2 text-sm font-semibold text-[var(--cream)] bg-[var(--brand)] hover:bg-[var(--brand-dark)] transition-colors">
                    Login
                </a>
            </div>
        </div>
    ...
    <footer class="border-t border-[var(--line)] bg-[var(--beige)]/50">
        <div class="mx-auto max-w-7xl px-6 py-14 lg:px-10">
            <div class="grid grid-cols-1 gap-10 md:grid-cols-[1.4fr_1fr_1fr_1fr]">
                <div>
                    ...
                    <div class="mt-5 flex gap-3">
                        @foreach (['M4 4h16v16H4z','circle','wave','pin'] as $i => $icon)
                            <a href="#" aria-label="Social link" class="flex h-9 w-9 items-center justify-center rounded-full border border-[var(--line)] text-[var(--charcoal-soft)] hover:text-[var(--brand)] hover:border-[var(--brand)] transition-colors">
                                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" aria-hidden="true"><circle cx="12" cy="12" r="9" stroke="currentColor" stroke-width="1.6"/></svg>
                            </a>
                        @endforeach
                    </div>
                </div>
                ...
                <div>
                    ...
                    <ul class="mt-4 space-y-2.5 text-sm text-[var(--charcoal-soft)]">
                        <li><a href="/" class="hover:text-[var(--brand)]">Home</a></li>
                        <li><a href="/about" class="hover:text-[var(--brand)]">About</a></li>
                        <li><a href="/product" class="hover:text-[var(--brand)]">Product</a></li>
                        <li><a href="/order" class="hover:text-[var(--brand)]">Order</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="mt-4 space-y-2.5 text-sm text-[var(--charcoal-soft)]">
                        <li><a href="mailto:hello@tikonacoffee.com" class="hover:text-[var(--brand)]">hello@tikonacoffee.com</a></li>
                ...
                <div>
                    <h3 class="text-sm font-semibold uppercase tracking-wide text-[var(--charcoal)]">Roastery Hours</h3>
                    <ul class="mt-4 space-y-2.5 text-sm text-[var(--charcoal-soft)]">
            ...
            <div class="mt-12 flex flex-col items-center justify-between gap-4 border-t border-[var(--line)] pt-6 text-xs text-[var(--charcoal-soft)] md:flex-row">
